...
#   sbatch slurm_scripts/gen_amaze.sh test  maze
#   sbatch slurm_scripts/gen_amaze.sh train maze   n=8 type=hexagon
#   sbatch slurm_scripts/gen_amaze.sh train queens n=7
...
EXTRA="${*:3}"              # optional hydra-style tokens, e.g. n=8 type=hexagon
