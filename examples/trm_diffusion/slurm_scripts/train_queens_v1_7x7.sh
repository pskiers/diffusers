#!/bin/bash -l
#SBATCH --job-name=amaze_queens_v1_7x7
...
RUN_NAME="${RUN_NAME:-${2:-queens_v1_${N}x${N}${SLURM_JOB_ID:+_${SLURM_JOB_ID}}}}"
...
AMAZE_OUT_ROOT="${PROJECT_ROOT}/data/amaze" \
  python scripts/gen_amaze.py train "${TASK}" --size ${N}
DATA_DIR="${PROJECT_ROOT}/data/amaze/train_queens/n${N}_train_size144"
