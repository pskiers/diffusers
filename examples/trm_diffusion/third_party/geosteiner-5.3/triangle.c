...
/*    John R. Rice, editor, Academic Press,  York, pp. 161-194, 1977.     */
...
#undef malloc
  ...
  #define malloc(a)  _gst_allocate_memory (a, __FILE__, __FUNCTION__, __LINE__)
  #undef free
  ...
  #define malloc(a)  _gst_allocate_memory (a, __FILE__, __LINE__)
  #undef free
  #define free(a) _gst_free_memory (a, __FILE__, __LINE__)
 #endif
#else
 extern void * _gst_new (size_t);
 #define malloc(s) (_gst_new (s))
#endif
