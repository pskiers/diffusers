...
environments/utils/utils_pybullet.py. Only changes: import paths adapted to
this package, and `tensorflow` made a lazy import inside save_state/load_state
(the only two functions that use it) so it isn't a hard dependency for the
rest of this module — we don't use TF-based state snapshotting.
"""
import dataclasses
import datetime
import getpass
...
def write_pybullet_state(filename, pybullet_state, task,
  ...
  import tensorflow as tf  # lazy: only these two functions need it
