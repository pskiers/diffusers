...
from third_party.block_pushing.utils import utils_pybullet
from third_party.block_pushing.utils import xarm_sim_robot
from third_party.block_pushing.utils.pose3d import Pose3d
from third_party.block_pushing.utils.utils_pybullet import ObjState
from third_party.block_pushing.utils.utils_pybullet import XarmState
import numpy as np
...
# debugging.
# gym>=0.26's registry is a plain dict with no .env_specs attribute (this
# block is old gym<0.26 API, only relevant for interactive/notebook module
# reloads) — swallow the AttributeError rather than crashing on import.
try:
