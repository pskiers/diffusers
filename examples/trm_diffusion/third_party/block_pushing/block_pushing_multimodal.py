...
environments/block_pushing/block_pushing_multimodal.py. Same changes as
block_pushing.py: import paths adapted, `metrics`/TensorFlow made a lazy
import inside the unused get_metrics() override, asset paths point at this
package's assets/ dir.
"""
...
from third_party.block_pushing import block_pushing
...
# pytype: skip-file
BLOCK2_URDF_PATH = os.path.join(os.path.dirname(__file__), 'assets', 'block2.urdf')
ZONE2_URDF_PATH = os.path.join(os.path.dirname(__file__), 'assets', 'zone2.urdf')
